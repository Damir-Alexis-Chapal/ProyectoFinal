...
public class Datos implements Serializable {
    ...
    public static void imprimirListado(ArrayList<?> lista) {
        for (Object objeto : lista) {
            if (objeto instanceof ArrayList) {
                // Si el objeto es un ArrayList, llamamos recursivamente a la función
                imprimirListado((ArrayList<?>) objeto);
            } else {
                // Si no, simplemente lo imprimimos
