...
public class VerTorneoVolley extends javax.swing.JFrame {
    ...
    private void VerDatosTorneo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerDatosTorneo1ActionPerformed
        ...
        VerDatos.ver_datos(Datos.listado_torneos_volley.get(0));//mandamos como parámetro el torneo que queremos consultar
    ...
    private void VerDatosTorneo2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerDatosTorneo2ActionPerformed
        VerDatos.ver_datos(Datos.listado_torneos_volley.get(1));//mandamos como parámetro el torneo que queremos consultar
    ...
    private void VerDatosTorneo3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerDatosTorneo3ActionPerformed
        VerDatos.ver_datos(Datos.listado_torneos_volley.get(2));//mandamos como parámetro el torneo que queremos consultar
    ...
    private void VerDatosTorneo4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_VerDatosTorneo4ActionPerformed
        VerDatos.ver_datos(Datos.listado_torneos_volley.get(3));//mandamos como parámetro el torneo que queremos consultar
